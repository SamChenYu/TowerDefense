...
public class Map {
    ...
    public void loadMap(String filePath) {
        ...
        try {
            ...
            BufferedReader br = new BufferedReader(new FileReader(filePath)); // reads the text file
    ...
    public boolean buildableTile() {
        return getTileCode(mapArray[returnRow][returnCol]).buildable;
        //When a tower is placed, this function will check whether the 
        //Tile can be built on or not
    }
